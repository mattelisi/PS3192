...
# Perform k-means clustering
kmeans_fit <- kmeans(dat, centers = 2)
...
# Perform k-means clustering 
kmeans_fit <- kmeans(dat, centers = 4)
...
# Perform k-means clustering 
kmeans_fit <- kmeans(dat, centers = 5)
...
# Perform k-means clustering 
kmeans_fit <- kmeans(dat, centers = 6)
...
# Perform k-means clustering 
kmeans_fit <- kmeans(dat, centers = 7)
...
# Perform k-means clustering 
kmeans_fit <- kmeans(dat, centers = 8)
...
# Perform k-means clustering 
kmeans_fit <- kmeans(dat, centers = 9)
...
# Perform k-means clustering 
kmeans_fit <- kmeans(dat, centers = 10)
