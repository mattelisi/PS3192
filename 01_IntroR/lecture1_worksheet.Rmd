...
![The R command prompt looks like `>`. You can type in commands and they will run once you hit `Enter`. At its simplest, you can think of this as a fancy calculator.](r_prompt.PNG) As such you can use operators like `+`, `-`, `*` (for multiplication), `/`, etc. to do calculations:
