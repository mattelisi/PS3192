---
title: "Decision tree — worked example on `GermanCredit` dataset"
...
```
Which tells us that the majority of observations are in the `Good` class, and that expected error when predicting all datapointss to be `good` is the fraction of `bad` datapoints, that is 300 / (700 + 300) = 0.3.
